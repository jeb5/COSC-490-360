...
def main():
  ...
  input_video_path = "./input/bscr4.mkv"
  input_rotation_path = "./input/bscr4.csv"
  output_video_path = "./output/output_360_4.mp4"
  ...
  print(f"Vertical FOV: {vertical_fov:.2f} degrees, Horizontal FOV: {horizontal_fov:.2f} degrees")
